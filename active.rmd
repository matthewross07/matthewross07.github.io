...
Or as it turns out change your code to use `data.table`. This is a well-documented advantage of data.table
over dplyr as shown [here](https://github.com/Rdatatable/data.table/wiki/Benchmarks-%3A-Grouping)